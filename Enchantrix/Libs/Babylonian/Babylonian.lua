--[[
	...
	Version: 1.13.6579 (SwimmingSeadragon)
	Revision: $Id: Babylonian.lua 6579 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Babylonian/Babylonian.lua $","$Rev: 6579 $","5.1.DEV.", 'auctioneer', 'libs')
