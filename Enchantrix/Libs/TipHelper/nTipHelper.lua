--[[
	...
	Version: 1,4
	Revision: $Id: nTipHelper.lua 6580 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/TipHelper/nTipHelper.lua $","$Rev: 6580 $","5.12.DEV.", 'auctioneer', 'libs')
