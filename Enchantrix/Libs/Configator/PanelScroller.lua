--[[
	...
	Revision: $Id: PanelScroller.lua 6670 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/PanelScroller.lua $","$Rev: 6670 $","5.1.DEV.", 'auctioneer', 'libs')
