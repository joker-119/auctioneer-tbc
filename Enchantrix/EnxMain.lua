--[[
	...
	Revision: $Id: EnxMain.lua 6662 2021-01-30 13:42:33Z none $
...
Enchantrix_RegisterRevision("$URL: Enchantrix/EnxMain.lua $", "$Rev: 6662 $")
...
function addonLoaded(hookArgs, event, addOnName)
	...
	Enchantrix.Revision = Enchantrix.Util.GetRevision("$Rev: 6662 $")
