--[[
	...
	Version: 1.13.6668 (SwimmingSeadragon)
	Revision: $Id: SlideMain.lua 6668 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: SlideBar/SlideMain.lua $","$Rev: 6668 $","6.0.DEV.", 'auctioneer', 'libs')
...
function private.GUI()
	...
	-- Create base panel and initialize
	...
	local reset = CreateFrame("Button", nil, frame.config, "OptionsButtonTemplate")
	config.reset = reset
	reset:SetWidth(160)
