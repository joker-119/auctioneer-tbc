--[[
	...
	Revision: $Id: SelectBox.lua 6670 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/Configator/SelectBox.lua $","$Rev: 6670 $","5.1.DEV.", 'auctioneer', 'libs')
