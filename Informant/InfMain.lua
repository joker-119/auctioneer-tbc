--[[
	...
	Version: 1.13.6650 (SwimmingSeadragon)
	Revision: $Id: InfMain.lua 6650 2021-01-30 13:42:33Z none $
...
Informant_RegisterRevision("$URL: Informant/InfMain.lua $","$Rev: 6650 $")

INFORMANT_VERSION = "1.13.6650"
