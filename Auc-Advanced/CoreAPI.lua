--[[
	...
	Revision: $Id: CoreAPI.lua 6664 2021-01-30 13:42:33Z none $
...
local function newBar()
	local bar = CreateFrame("STATUSBAR", nil, UIParent, "TextStatusBar", BackdropTemplateMixin and "BackdropTemplate")
	bar:SetWidth(300)
	bar:SetHeight(18)
--	bar:SetBackdrop({bgFile="Interface\\Tooltips\\UI-Tooltip-Background", edgeFile="Interface\\Tooltips\\UI-Tooltip-Border", tile=1, tileSize=10, edgeSize=10,	insets={left=1, right=1, top=1, bottom=1}})
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/CoreAPI.lua $", "$Rev: 6664 $")
