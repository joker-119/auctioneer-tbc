--[[
	...
	Revision: $Id: CoreManifest.lua 6664 2021-01-30 13:42:33Z none $
...
-- Manifest Constants
local DEV_VERSION = "9.0.DEV"
local MINIMUM_TOC = 11300
local MINIMUM_CLIENT = "1.13.0"
local CLASSIC_2 = 20000
local CLASSIC_MAX = 29999
...
if tocVersion <= CLASSIC_MAX then
	-- In anticipation of possible Classic Burning Crusade version, will use lib.Classic to indicate the tier
	if tocVersion >= CLASSIC_2 then
		lib.Classic = 2
	else
		lib.Classic = 1
	end
...
lib.RegisterRevision("$URL: Auc-Advanced/CoreManifest.lua $", "$Rev: 6664 $")
