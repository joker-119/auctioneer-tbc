--[[
	...
	Revision: $Id: CorePost.lua 6664 2021-01-30 13:42:33Z none $
...
do --[[ Deposit Cost Calculator ]]--
	...
	function lib.GetDepositCost(item, duration, faction, stacksize, numstacks)
		...
		if faction and faction ~= true and type(faction) ~= "string" then
		...
		if vendor then
			...
			if faction == true or faction == "Neutral" or faction == "neutral" then
...
private.Prompt = CreateFrame("Frame", "AuctioneerPostPrompt", UIParent, BackdropTemplateMixin and "BackdropTemplate")
private.Prompt:Hide()
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/CorePost.lua $", "$Rev: 6664 $")
