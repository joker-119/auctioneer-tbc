--[[
	...
	Version: 1.13.6597 (SwimmingSeadragon)
	Revision: $Id: Auc-Util-AutoMagic.lua 6597 2021-01-30 13:42:33Z none $
...
local eventframe = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate") -- used for Events and for timer (via Update)
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AutoMagic/Auc-Util-AutoMagic.lua $", "$Rev: 6597 $")
