--[[
	...
	Version: 1.13.6647 (SwimmingSeadragon)
	Revision: $Id: AprFrame.lua 6647 2021-01-30 13:42:33Z none $
...
function private.CreateFrames()
	...
	frame = CreateFrame("Frame", "AucAdvAppraiserFrame", AuctionFrame, BackdropTemplateMixin and "BackdropTemplate")
	private.frame = frame
...
--		frame.DirectSelect(link)
   ...
   -- Would rather the distance here matched the length of the "All Stacks" text and was recalculated.
	...
	frame.salebox.bid = CreateFrame("Frame", "AppraiserSaleboxBid", frame.salebox, BackdropTemplateMixin and "BackdropTemplate" and "MoneyInputFrameTemplate")
	...
	frame.salebox.bid:Hide()
	--AppraiserSaleboxBidGold:SetBackdrop({bgFile = "Interface/Tooltips/UI-Tooltip-Background",tile = true, tileSize = 32,insets = { left = -2, right = 3, top = 4, bottom = 2}})
	--AppraiserSaleboxBidGold:SetBackdropColor(0,0,0, 0)
	--AppraiserSaleboxBidSilver:SetBackdrop({bgFile = "Interface/Tooltips/UI-Tooltip-Background",tile = true, tileSize = 32,insets = { left = -2, right = 12, top = 4, bottom = 2}})
	--AppraiserSaleboxBidSilver:SetBackdropColor(0,0,0, 0)
	--AppraiserSaleboxBidCopper:SetBackdrop({bgFile = "Interface/Tooltips/UI-Tooltip-Background",tile = true, tileSize = 32,insets = { left = -2, right = 12, top = 4, bottom = 2}})
	--AppraiserSaleboxBidCopper:SetBackdropColor(0,0,0, 0)


	frame.salebox.bid.stack = CreateFrame("Frame", "AppraiserSaleboxBidStack", frame.salebox, BackdropTemplateMixin and "BackdropTemplate" and "MoneyInputFrameTemplate")
	...
	frame.salebox.buy = CreateFrame("Frame", "AppraiserSaleboxBuy", frame.salebox, BackdropTemplateMixin and "BackdropTemplate" and "MoneyInputFrameTemplate")
	...
	frame.salebox.buy.stack = CreateFrame("Frame", "AppraiserSaleboxBuyStack", frame.salebox, BackdropTemplateMixin and "BackdropTemplate" and "MoneyInputFrameTemplate")
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-Appraiser/AprFrame.lua $", "$Rev: 6647 $")
