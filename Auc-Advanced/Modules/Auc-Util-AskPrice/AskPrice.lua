--[[
	...
	Version: 1.13.6590 (SwimmingSeadragon)
	Revision: $Id: AskPrice.lua 6590 2021-01-30 13:42:33Z none $
...
function lib.OnLoad(addon)
	private.frame = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
function private.GetVersion()
	return tonumber(("$Rev: 6590 $"):match("(%d+)")), (AucAdvanced.GetCurrentRevision()) --We just want the first return from GetCurrentRevision()
end
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-AskPrice/AskPrice.lua $", "$Rev: 6590 $")
