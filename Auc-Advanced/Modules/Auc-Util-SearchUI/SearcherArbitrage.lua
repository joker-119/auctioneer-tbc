--[[
	...
	Revision: $Id: SearcherArbitrage.lua 6645 2021-01-30 13:42:33Z none $
...
function lib.Search(item)
	...
	if get("arbitrage.adjust.deposit") then
		local amount = resources.GetDepositCost(link, get("arbitrage.adjust.deplength"), resources.Faction, count)
		if amount then
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherArbitrage.lua $", "$Rev: 6645 $")
