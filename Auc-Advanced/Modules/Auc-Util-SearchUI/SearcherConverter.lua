--[[
	...
	Revision: $Id: SearcherConverter.lua 6645 2021-01-30 13:42:33Z none $
...
function lib.Search (item)
	...
	if get("converter.adjust.deposit") then
		...
		local amount = resources.GetDepositCost(newID, get("converter.adjust.deplength"), resources.Faction, count)
		if amount then
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherConverter.lua $", "$Rev: 6645 $")
