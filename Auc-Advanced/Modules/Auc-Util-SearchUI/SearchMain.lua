--[[
	...
	Revision: $Id: SearchMain.lua 6645 2021-01-30 13:42:33Z none $
...
function private.CreateAuctionFrames()
	...
	local frame = CreateFrame("Frame", "AucAdvSearchUiAuctionFrame", AuctionFrame, BackdropTemplateMixin and "BackdropTemplate")
...
function private.MakeGuiConfig()
	...
	gui.saves = CreateFrame("Frame", nil, gui, BackdropTemplateMixin and "BackdropTemplate")
	...
	do -- bid button and bid box
		...
		local bidbox = CreateFrame("Frame", "AucAdvSearchUIBidBox", gui.frame, BackdropTemplateMixin and "BackdropTemplate" and "MoneyInputFrameTemplate")
	...
	gui.frame.progressbar = CreateFrame("STATUSBAR", nil, gui.frame, BackdropTemplateMixin and "BackdropTemplate" and "TextStatusBar")
	...
	--gui.frame.progressbar:SetBackdrop({bgFile="Interface\\Tooltips\\UI-Tooltip-Background",edgeFile="Interface\\Tooltips\\UI-Tooltip-Border",tile=1, tileSize=10, edgeSize=10,insets={left=3, right=3, top=3, bottom=3}})
...
private.updater = CreateFrame("Frame", nil, UIParent, BackdropTemplateMixin and "BackdropTemplate")
private.updater:SetScript("OnUpdate", OnUpdate)

AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearchMain.lua $", "$Rev: 6645 $")
