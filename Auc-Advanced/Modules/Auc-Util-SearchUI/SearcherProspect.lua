--[[
	...
	Revision: $Id: SearcherProspect.lua 6645 2021-01-30 13:42:33Z none $
...
function lib.Search(item)
	...
	for result, yield in pairs(prospects) do
		...
		if includeDeposit then
			local aadvdepcost = resources.GetDepositCost(result, depositAucLength, resources.Faction, yield) or 0
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-SearchUI/SearcherProspect.lua $", "$Rev: 6645 $")
