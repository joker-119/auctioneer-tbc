--[[
	...
	Version: 1.13.6583 (SwimmingSeadragon)
	Revision: $Id: ScanButton.lua 6583 2021-01-30 13:42:33Z none $
...
function private.HookAH()
	private.buttons = CreateFrame("Frame", nil, AuctionFrameBrowse, BackdropTemplateMixin and "BackdropTemplate")
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-ScanButton/ScanButton.lua $", "$Rev: 6583 $")
