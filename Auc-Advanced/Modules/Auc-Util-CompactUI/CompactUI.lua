--[[
	...
	Version: 1.13.6598 (SwimmingSeadragon)
	Revision: $Id: CompactUI.lua 6598 2021-01-30 13:42:33Z none $
...
function private.HookAH()
	...
	private.headers = CreateFrame("Frame", nil, AuctionFrameBrowse, BackdropTemplateMixin and "BackdropTemplate")
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-CompactUI/CompactUI.lua $", "$Rev: 6598 $")
