--[[
	...
	Version: 1.13.6600 (SwimmingSeadragon)
	Revision: $Id: ScanStart.lua 6600 2021-01-30 13:42:33Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Util-ScanStart/ScanStart.lua $", "$Rev: 6600 $")
