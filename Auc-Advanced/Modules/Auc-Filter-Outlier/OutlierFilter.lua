--[[
	...
	Version: 1.13.6594 (SwimmingSeadragon)
	Revision: $Id: OutlierFilter.lua 6594 2021-01-30 13:42:33Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Advanced/Modules/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 6594 $")
