--[[
	...
	Version: 1.13.6652 (SwimmingSeadragon)
	Revision: $Id: Swatter.lua 6652 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: !Swatter/Swatter.lua $","$Rev: 6652 $","6.0.DEV.", 'auctioneer', 'libs')
