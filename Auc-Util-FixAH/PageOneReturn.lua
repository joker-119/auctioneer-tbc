--[[
	...
	Version: 1.13.6608 (SwimmingSeadragon)
	Revision: $Id: PageOneReturn.lua 6608 2021-01-30 13:42:33Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Util-FixAH/PageOneReturn.lua $", "$Rev: 6608 $")
