--[[
	...
	Version: 1.13.6614 (SwimmingSeadragon)
	Revision: $Id: Stubby.lua 6614 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Stubby/Stubby.lua $","$Rev: 6614 $","5.1.DEV.", 'auctioneer', 'libs')
...
function getRevision()
	return tonumber(("$Rev: 6614 $"):match("(%d+)"))
end
