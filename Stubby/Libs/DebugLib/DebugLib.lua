--[[
	...
	Version: 1.13.6576 (SwimmingSeadragon)
	Revision: $Id: DebugLib.lua 6576 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: Auc-Advanced/Libs/DebugLib/DebugLib.lua $","$Rev: 6576 $","5.1.DEV.", 'auctioneer', 'libs')
