--[[
	...
	Revision: $Id: BeanCounter.lua 6609 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounter.lua $","$Rev: 6609 $","5.1.DEV.", 'auctioneer', 'libs')
...
--[[DE event frame]]
private.DisenchantScriptframe = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
...
--[[Bootstrap Code]]
private.scriptframe = CreateFrame("Frame", BackdropTemplateMixin and "BackdropTemplate")
