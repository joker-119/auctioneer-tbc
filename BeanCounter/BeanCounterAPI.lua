--[[
	...
	Revision: $Id: BeanCounterAPI.lua 6609 2021-01-30 13:42:33Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterAPI.lua $","$Rev: 6609 $","5.1.DEV.", 'auctioneer', 'libs')
