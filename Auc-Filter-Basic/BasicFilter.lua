--[[
	...
	Version: 1.13.6601 (SwimmingSeadragon)
	Revision: $Id: BasicFilter.lua 6601 2021-01-30 13:42:33Z none $
...
AucAdvanced.RegisterRevision("$URL: Auc-Filter-Basic/BasicFilter.lua $", "$Rev: 6601 $")
